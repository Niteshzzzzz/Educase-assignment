...
function InputField({label, type}) {
    return (
        <div className="relative mb-6">
            <input type={type} id="name" name='name' placeholder='Marry Doe' className='border-1 border-[#CBCBCB] rounded text-black-700 px-4 py-2 w-full focus:outline-[#6C25FF]' ></input>
