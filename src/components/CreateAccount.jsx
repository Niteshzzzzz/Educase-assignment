...
function CreateAccount() {
    ...
    return (
        <div className="w-[375px] min-h-[612px] border-2 rounded border-[#F7F8F9] flex flex-col bg-[#F7F8F9]">
            <form action="/account" className='h-[612px] px-4 py-6 flex flex-col justify-between'>
                <div className="">
                ...
                <div className="">
                    <button to={'/account'} className='w-full bg-[#6C25FF] mt-8 text-white flex justify-center items-center p-2 text-base rounded'>Create Account</button>
                </div>
            </form>
        </div>
    )
